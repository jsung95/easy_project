...
{
    public class BlackOutDatesHelper : DependencyObject
    {
        ...
        public static DependencyProperty RegisterBlackoutDatesProperty = DependencyProperty.RegisterAttached("RegisterBlackoutDates", typeof(System.Windows.Controls.CalendarBlackoutDatesCollection), typeof(BlackOutDatesHelper), new PropertyMetadata(null, OnRegisterCommandBindingChanged));
